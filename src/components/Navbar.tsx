      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          >
            ...
            <Link to="/" className="text-2xl font-bold bg-gradient-to-r from-crypto-neon to-crypto-purple bg-clip-text text-transparent">
              DulpPoints
            </Link>
          </motion.div>
              ...
              <>
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <span className="hidden sm:block">{currentUser.email?.split('@')[0]}</span>
                  </motion.button>
